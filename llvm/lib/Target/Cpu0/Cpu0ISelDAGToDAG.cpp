...
void Cpu0DAGToDAGISel::getAnalysisUsage(AnalysisUsage &AU) const {
  // There are multiple Cpu0DAGToDAGISel instances added to the pass pipeline.
...
SDNode *Cpu0DAGToDAGISel::getGlobalBaseReg() {
  ...
  MF->getInfo<Cpu0FunctionInfo>()->getGlobalBaseReg(); return CurDAG
...
INITIALIZE_PASS(Cpu0DAGToDAGISel, DEBUG_TYPE, PASS_NAME, false, false)