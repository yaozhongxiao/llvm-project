...
SDValue Cpu0TargetLowering::LowerCall(TargetLowering::CallLoweringInfo &CLI,
  ...
  if (!Cpu0ReserveGP) {
    ...
    if (Cpu0FI->needGPSaveRestore())
      MFI.setObjectOffset(Cpu0FI->getGPFI(), StackSize);
  }
#endif
  ...
  if (IsTailCall)
    IsTailCall = isEligibleForTailCallOptimization(
        Cpu0CCInfo, StackSize, *MF.getInfo<Cpu0FunctionInfo>());
  ...
  SDValue NextStackOffsetVal = DAG.getIntPtrConstant(StackSize, DL, true);
